...
1. Abra o arquivo e edite manualmente, decidindo o que deve ficar;
2. Remova os marcadores (`<<<<<<<`, `=======`, `>>>>>>>`);
3. Adicione o arquivo resolvido ao stage:
...
1. `git pull` para atualizar antes de começar a trabalhar;
2. Criar uma branch para a sua tarefa;
3. Fazer commits normalmente;
4. Enviar (`git push`) a branch para o GitHub;
...
3. Descreva as alterações feitas;
4. Aguarde revisão/aprovação;
5. Faça o merge do PR na branch principal.
